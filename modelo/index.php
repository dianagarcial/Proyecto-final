...
$sql1="SELECT PROGRAMAACADEMICO.nombre as prog FROM DIRECTORPROGRAMA JOIN PROGRAMAACADEMICO ON DIRECTORPROGRAMA.codigo_prog = PROGRAMAACADEMICO.codigo  WHERE DIRECTORPROGRAMA.correo_usuario='juan.carlos@uao.edu.co';";
$sql2="SELECT ASIGNATURA.nombre as asig FROM USUARIO JOIN DIRECTORPROGRAMA ON USUARIO.correo= DIRECTORPROGRAMA.correo_usuario JOIN PROGRAMAACADEMICO ON DIRECTORPROGRAMA.codigo_prog= PROGRAMAACADEMICO.codigo JOIN ASIGNACION ON ASIGNACION.codigoprogra= PROGRAMAACADEMICO.codigo JOIN ASIGNATURA ON ASIGNACION.codigoasig=ASIGNATURA.codigo WHERE DIRECTORPROGRAMA.correo_usuario='juan.carlos@uao.edu.co';";
$sql3="SELECT USUARIO.nombre as nombre, USUARIO.apellido as apellido FROM USUARIO JOIN DIRECTORPROGRAMA ON USUARIO.correo= DIRECTORPROGRAMA.correo_usuario WHERE DIRECTORPROGRAMA.correo_usuario='juan.carlos@uao.edu.co';";
