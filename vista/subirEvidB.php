...
<div id="contenido">
        ...
        <div class= formatorow1>
            <h1 id=titu>Subir evidencias de CALIDAD BAJA</h1>
        ...
        <input type="hidden" name="codAct" value=<?php echo $activid-> getid()?>></input>
                    ...
                    <div class=columinfo1>
                        ...
                        <label class="labelestado" id="nomdoc" name="nivel">Baja<label> 
                ...
                <input type='hidden' name='insertarEB' value='insertarEB'>
